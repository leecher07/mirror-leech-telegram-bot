...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Code Website", "https://www.github.com")
    buttons.buildbutton("Report Group", "https://t.me/anonymous7205")
    reply_markup = InlineKeyboardMarkup(buttons.build_menu(2))
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''
I can mirror all your links to Google Drive, only work for cinemaHub!
